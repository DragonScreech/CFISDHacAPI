...
class handler(BaseHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    pastCoursesRequestHeaders = {
        ...
        "Origin": "https://home-access.cfisd.net",
        "Referer": "https://home-access.cfisd.net/HomeAccess/Content/Student/Assignments.aspx"
    }
    ...
    pastCoursesPageContent = session.post(
        "https://home-access.cfisd.net/HomeAccess/Content/Student/Assignments.aspx",
